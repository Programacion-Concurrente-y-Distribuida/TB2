...
#define PanSource	"union_y_limpieza.pml"
...
#define _nstates7	11	/* invariante_dataset */
#define minseq7	94
#define maxseq7	103
#define _endstate7	10

#define _nstates6	14	/* progreso_workers */
#define minseq6	81
#define maxseq6	93
#define _endstate6	13

#define _nstates5	14	/* cada_job_se_procesa */
#define minseq5	68
#define maxseq5	80
#define _endstate5	13

#define _nstates4	7	/* todos_procesados */
#define minseq4	62
#define maxseq4	67
#define _endstate4	6

#define _nstates3	25	/* :init: */
#define minseq3	38
#define maxseq3	61
#define _endstate3	24

#define _nstates2	18	/* recolector */
#define minseq2	21
#define maxseq2	37
#define _endstate2	17

#define _nstates1	4	/* cerrador */
#define minseq1	18
#define maxseq1	20
#define _endstate1	3

#define _nstates0	19	/* worker */
#define minseq0	0
#define maxseq0	17
...
typedef struct P7 { /* invariante_dataset */
...
typedef struct P6 { /* progreso_workers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* cada_job_se_procesa */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* todos_procesados */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Precolector	((P2 *)_this)
typedef struct P2 { /* recolector */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, filas) - 1*sizeof(uchar))

#define Pcerrador	((P1 *)_this)
typedef struct P1 { /* cerrador */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, filas) - 1*sizeof(uchar))
...
typedef struct State {
	...
	#endif
#endif
	unsigned jobs_closed : 1;
	unsigned results_closed : 1;
	unsigned mutex_ocupado : 1;
	uchar jobs_enviados;
	uchar jobs_procesados;
	uchar total_records;
	uchar finalDataset_size;
	uchar workers_vivos;
	uchar jobs;
	uchar results;
	uchar mu;
