...
#define PanSource	"descargar.pml"
...
#define _nstates5	11	/* sem_respetado */
#define minseq5	65
#define maxseq5	74
#define _endstate5	10

#define _nstates4	14	/* progreso_wg */
#define minseq4	52
#define maxseq4	64
#define _endstate4	13

#define _nstates3	7	/* terminacion */
#define minseq3	46
#define maxseq3	51
#define _endstate3	6

#define _nstates2	11	/* no_exceso */
#define minseq2	36
#define maxseq2	45
...
#define _nstates0	22	/* descargador */
#define minseq0	0
#define maxseq0	20
...
typedef struct P5 { /* sem_respetado */
...
#define Pdescargador	((P0 *)_this)
typedef struct P0 { /* descargador */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	uchar downloaded_count;
	uchar finished_count;
	uchar active_downloads;
	uchar sem;
	uchar mu;
#ifdef TRIX
